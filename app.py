...
st.set_page_config(page_title="CC Reporter", page_icon="💳",
...
<div style="margin-top:32px;padding:14px 0 8px;border-top:0.5px solid #ddd;
  ...
  <div style="display:flex;align-items:center;gap:8px;">
    <div style="width:24px;height:24px;border-radius:6px;background:#191d3a;
...
<div style="background:#f0fdf4;border:1px solid #86efac;border-radius:12px;
  ...
  📅 Timestamp &nbsp;·&nbsp; 💰 Total (Rp) &nbsp;·&nbsp; 💳 Kartu Kredit &nbsp;·&nbsp; 📄 Booking ID
        ...
        _ne_clear = st.button("Hapus",type="secondary",use_container_width=True,key="ne_clear")
        st.markdown('</div>',unsafe_allow_html=True)
